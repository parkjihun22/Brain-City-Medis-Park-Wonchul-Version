  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.screenReaderOnly}>
        평택 브레인시티 메디스파크 - 체크포인트
      </h1>

      <p className={styles.screenReaderOnly}>
        평택 브레인시티 메디스파크 분양 체크포인트 안내 페이지입니다.
        청약 자격, 서류 준비, 일정 등 분양 절차에서 반드시 확인해야 할
        주요 사항을 확인하실 수 있습니다.
      </p>

      <div className={styles.textBox}>
        <div>분양 전 꼭 확인해야 할</div>
        <div>평택 브레인시티 메디스파크 체크포인트</div>
      </div>
      ...
      <img
        ...
        src={page1}
        alt="평택 브레인시티 메디스파크 청약 체크포인트 이미지"
