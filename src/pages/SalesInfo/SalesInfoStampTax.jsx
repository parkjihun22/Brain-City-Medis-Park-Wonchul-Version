  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.screenReaderOnly}>
        평택 브레인시티 메디스파크 - 인지세안내
      </h1>

      <p className={styles.screenReaderOnly}>
        평택 브레인시티 메디스파크 인지세안내 페이지입니다.
        분양 계약 시 필요한 인지세 안내와 납부 방법, 유의사항을 확인하실 수 있습니다.
      </p>

      <div className={styles.textBox}>
        <div>분양 계약 전 꼭 확인해야 할</div>
        <div>평택 브레인시티 메디스파크 인지세안내</div>
      </div>
