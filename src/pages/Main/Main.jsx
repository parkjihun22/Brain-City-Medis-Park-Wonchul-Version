...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `안심 학세권 프리미엄`,
    text2: `브레인시티 내 초·중·고 모두 개교 예정<br />
            카이스트 평택캠퍼스 2027년 개교 예정`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `경기도권 내 펜타역세권 광역교통망`,
    text2: `평택 지제역 1호선, SRT·KTX·GTX A·C라인<br />
            송탄IC, 동부화고속도로(예정) 등`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
            ...
            <div className={styles.imageContainer}>
              ...
              <div className={styles.mainImageTextBox}>
                ...
                <div className={styles.mainImageTitleBox}>
                  ...
                  <div className={styles.mainImageText}>평택 브레인시티 메디스파크</div>
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section1}>
              ...
              <div className={styles.menuBox}>
                <img src={section1_Image1} alt="평택 브레인시티 메디스파크브랜드소개-image2" />
            ...
            <div className={styles.section8}>
              <div className={styles.textBox}>
                <div className={styles.title}>
                  소수만 누릴 수 있는<br />
                  <span>착한가격의 아파트 <br />평택 브레인시티 메디스파크</span>
                </div>
                <div className={styles.subTitle}>
                  <div className={styles.textLine}></div>
                  <div className={styles.subText}>
                    찬란한 비전에 완벽한 주거가치까지 더해<br />
                    평택 브레인시티 메디스파크이 함께합니다
                  </div>
                </div>
              </div>
              <img src={section8Img3} alt="평택 브레인시티 메디스파크입지환경소개-image2" />
            </div>
          </div>
            ...
            <div className={styles.section2}>
              <div className={styles.textBox}>
                ...
                <div className={`${styles.text2} fadeUpRepeat`}>
                  기대한 모든 프리미엄이<br />평택 브레인시티 메디스파크에서 펼쳐집니다
                </div>
              ...
              <img src={section2_Image1} alt="평택 브레인시티 메디스파크아파트 조감도-image3" />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img src={section4_Image1} alt="평택 브레인시티 메디스파크브랜드소개-image4" />
                <div className={styles.text1}>평택 브레인시티 메디스파크</div>
...
<div className={styles.pcVisitContainer}>
  ...
  <form
    ...
    action="https://formspree.io/f/xpqonrde"
    method="POST"
  >
    <label htmlFor="name">
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="평택 브레인시티 메디스파크오시는길안내-image1" />
            </div>
          </div> */}
  ...
  />
          ...
          <div className={styles.container7}>
            ...
            <img src={section8Img3} alt="평택 브레인시티 메디스파크mobile입지안내-image1" />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text2} fadeUpRepeat`}>
                기대한 모든 프리미엄이<br />
                평택 브레인시티 메디스파크에서 펼쳐집니다
              </div>
              <div className={`${styles.text3} fadeUpRepeat`}>SPECIAL PLAN</div>
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른<br />
                프리미엄 주거라이프를 평택 브레인시티 메디스파크 모델하우스에서 확인하세요
              </div>
            </div>
            <img src={section2_Image1} alt="평택 브레인시티 메디스파크mobile조감도-image1" />
          </div>
...
<div className={styles.mobileVisitContainer}>
  ...
  >
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img src={mobilemap1} alt="평택 브레인시티 메디스파크오시는길안내-mobileimage2" />
            </div>
          </div> */}
