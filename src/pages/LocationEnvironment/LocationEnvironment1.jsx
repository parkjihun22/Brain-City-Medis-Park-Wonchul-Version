  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <title>평택 브레인시티 메디스파크 - 입지안내</title>
        <meta
          name="description"
          content="평택 브레인시티 메디스파크 입지안내 페이지입니다. 교통, 산업, 의료, 교육, 생활 인프라를 가까이 누릴 수 있는 브레인시티의 입지환경과 미래가치를 확인하실 수 있습니다."
        />
        <meta
          name="keywords"
          content="평택 브레인시티 메디스파크, 브레인시티 메디스파크 입지안내, 평택 브레인시티 메디스파크 모델하우스"
        />
        <link rel="canonical" href="https://www.locamobility.co.kr/LocationEnvironment/intro" />

        <meta
          property="og:title"
          content="평택 브레인시티 메디스파크 - 입지안내"
        />
        <meta
          property="og:description"
          content="교통, 산업, 의료, 교육, 생활 인프라를 가까이 누릴 수 있는 평택 브레인시티 메디스파크의 입지환경을 확인해보세요."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://www.locamobility.co.kr/LocationEnvironment/intro"
        />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "name": "평택 브레인시티 메디스파크 - 입지안내",
              "description": "평택 브레인시티 메디스파크의 교통, 산업, 의료, 교육, 생활 인프라를 확인할 수 있는 입지안내 페이지입니다.",
              "url": "https://www.locamobility.co.kr/LocationEnvironment/intro"
            }
          `}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        평택 브레인시티 메디스파크의 입지안내 페이지입니다.
        교통, 산업, 의료, 교육, 생활 인프라를 가까이 누릴 수 있는
        브레인시티의 입지환경과 미래가치를 확인하실 수 있습니다.
      </p>

      <div className={styles.textBox}>
        <div>갈수록 기대되는 브레인시티의 중심</div>
        <div>살수록 높아지는 입지 프리미엄</div>
